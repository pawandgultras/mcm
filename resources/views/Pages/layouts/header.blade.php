    ...
    <div class="w-full md:w-auto hidden md:block" id="header-links">
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <nav class="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4 font-semibold text-sm">
          ...
          <div class="relative group">
            <div class="flex items-center gap-1 hover:text-primary cursor-pointer">
              <a href="#" class="py-3">Moving Office</a>
          ...
          <div class="relative group">
            <div class="flex items-center gap-1 hover:text-primary cursor-pointer">
              <a href="#" class="py-3">Moving an Organisation</a>
              <svg class="w-4 h-4 text-white group-hover:text-primary transition" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.108l3.71-3.877a.75.75 0 111.08 1.04l-4.25 4.44a.75.75 0 01-1.08 0l-4.25-4.44a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="absolute hidden group-hover:block bg-white text-black rounded shadow-lg pt-2 w-64 z-50">
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Commercial Removals</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">School Removals</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Hotel Removals</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Embassy Removals</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">IT Relocation</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Case Studies</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Areas We Cover</a>
            </div>
          </div>
          ...
          <div class="relative group">
            <div class="flex items-center gap-1 hover:text-primary cursor-pointer">
              <a href="#" class="py-3">Moving Overseas</a>
          ...
          <div class="relative group">
            <div class="flex items-center gap-1 hover:text-primary cursor-pointer">
              <a href="#" class="py-3">Storage</a>
              <svg class="w-4 h-4 text-white group-hover:text-primary transition" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.108l3.71-3.877a.75.75 0 111.08 1.04l-4.25 4.44a.75.75 0 01-1.08 0l-4.25-4.44a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
              </svg>
            </div>
            <div class="absolute hidden group-hover:block bg-white text-black rounded shadow-lg pt-2 w-64 z-50">
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Self Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Container Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Long Term Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Commercial Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Interior Design Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Life Event Storage</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Storage Size Calculator</a>
              <a href="#" class="block px-4 py-2 hover:bg-primary/10 hover:text-primary">Switch & Save</a>
            </div>
          </div>
